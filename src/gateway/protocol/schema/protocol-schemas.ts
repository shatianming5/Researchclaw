...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  GpuJobSubmitParams: GpuJobSubmitParamsSchema,
  GpuJobSubmitResult: GpuJobSubmitResultSchema,
  GpuJobGetParams: GpuJobGetParamsSchema,
  GpuJobGetResult: GpuJobGetResultSchema,
  GpuJobListParams: GpuJobListParamsSchema,
  GpuJobListResult: GpuJobListResultSchema,
  GpuJobCancelParams: GpuJobCancelParamsSchema,
  GpuJobCancelResult: GpuJobCancelResultSchema,
  GpuJobPauseParams: GpuJobPauseParamsSchema,
  GpuJobPauseResult: GpuJobPauseResultSchema,
  GpuJobResumeParams: GpuJobResumeParamsSchema,
  GpuJobResumeResult: GpuJobResumeResultSchema,
  GpuJobWaitParams: GpuJobWaitParamsSchema,
  GpuJobWaitResult: GpuJobWaitResultSchema,
  GpuJob: GpuJobSchema,
